...
from .config import ManifestConfig, load_config
...
def load_spec(path: str | Path) -> dict[str, Any]:
    """Load and validate a typed YAML experiment configuration."""

    return load_config(path).as_manifest_spec()
...
def validate_spec(spec: dict[str, Any]) -> None:
    try:
        ManifestConfig.model_validate(spec)
